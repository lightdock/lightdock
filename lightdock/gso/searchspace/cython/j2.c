...
#define __pyx_kp_u_j2_pyx __pyx_string_tab[1]
...
#define __pyx_n_u_j2 __pyx_string_tab[9]
...
#define __pyx_kp_b_iso88591_5_1ARr_Qc_1D_Baq_D_AQat1A __pyx_string_tab[21]
...
/* Python wrapper */
static PyObject *__pyx_pw_2j2_1j2(PyObject *__pyx_self, 
#if CYTHON_METH_FASTCALL
...
static PyMethodDef __pyx_mdef_2j2_1j2 = {"j2", (PyCFunction)(void(*)(void))(__Pyx_PyCFunction_FastCallWithKeywords)__pyx_pw_2j2_1j2, __Pyx_METH_FASTCALL|METH_KEYWORDS, 0};
static PyObject *__pyx_pw_2j2_1j2(PyObject *__pyx_self, 
#if CYTHON_METH_FASTCALL
PyObject *const *__pyx_args, Py_ssize_t __pyx_nargs, PyObject *__pyx_kwds
#else
PyObject *__pyx_args, PyObject *__pyx_kwds
  ...
  __pyx_kwvalues = __Pyx_KwValues_FASTCALL(__pyx_args, __pyx_nargs);
  {
    ...
    if (__pyx_kwds_len > 0) {
      ...
      if (__Pyx_ParseKeywords(__pyx_kwds, __pyx_kwvalues, __pyx_pyargnames, 0, values, kwd_pos_args, __pyx_kwds_len, "j2", 0) < (0)) __PYX_ERR(0, 9, __pyx_L3_error)
      for (Py_ssize_t i = __pyx_nargs; i < 2; i++) {
        if (unlikely(!values[i])) { __Pyx_RaiseArgtupleInvalid("j2", 1, 2, 2, i); __PYX_ERR(0, 9, __pyx_L3_error) }
      }
  ...
  __Pyx_RaiseArgtupleInvalid("j2", 1, 2, 2, __pyx_nargs); __PYX_ERR(0, 9, __pyx_L3_error)
  __pyx_L6_skip:;
...
#endif
{
  ...
  #if CYTHON_USE_MODULE_STATE
  {
    ...
    __pyx_t_1 = 0; /* transfer ownership from __pyx_t_1 to "j2" pseudovariable */
...
__Pyx_RefNannySetupContext("PyInit_j2", 0);
 ...
 *     return 20.0 + (x*x - 10.0*cos(2*M_PI*x) + y*y - 10.0*cos(2*M_PI*y))
*/
  __pyx_t_2 = __Pyx_CyFunction_New(&__pyx_mdef_2j2_1j2, 0, __pyx_mstate_global->__pyx_n_u_j2, NULL, __pyx_mstate_global->__pyx_n_u_j2, __pyx_mstate_global->__pyx_d, ((PyObject *)__pyx_mstate_global->__pyx_codeobj_tab[0])); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 9, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  #if CYTHON_COMPILING_IN_CPYTHON && PY_VERSION_HEX >= 0x030E0000
  PyUnstable_Object_EnableDeferredRefcount(__pyx_t_2);
  #endif
  if (PyDict_SetItem(__pyx_mstate_global->__pyx_d, __pyx_mstate_global->__pyx_n_u_j2, __pyx_t_2) < (0)) __PYX_ERR(0, 9, __pyx_L1_error)
...
static int __Pyx_InitConstants(__pyx_mstatetype *__pyx_mstate) {
  CYTHON_UNUSED_VAR(__pyx_mstate);
  {
    const struct { const unsigned int length: 6; } index[] = {{1},{6},{20},{12},{18},{18},{8},{13},{5},{2},{8},{10},{8},{3},{12},{12},{10},{8},{6},{1},{1},{63}};
    #if (CYTHON_COMPRESS_STRINGS) != 0 /* compression: zlib (211 bytes) */
const char* const cstring = "x\332=\2121N\303@\020Ee\240\243B\341\002p\200H\216D\215\214\\\243$\027\370\0326ci\223\365\256\343\235EvGI\351\322\245K\227.\267\31418\016\213@\374\342\3757\232\377|\334\254\233\276\003\266\t\333\276\324J\360\312\235\354\271\002\310Z'$\234\314\367Vi\267V\256uA\264e\257L\"\264\205\264\244\370\215\324\t\250\202U\000\264\307\377N\013\327\376\270\001jJ\333\224\332\035\202\341\037\263T\247n\\\003\234\003\231\337\023\360,\177\257d\007\256(\030\001\204}\342;\231\300\276\353?\262\257\233\333\317\247\341z\310\207b\330\017\355x?\356F5\335M\017S>\225s6\257\346\227\231\346\363r\265<.e\314\342*\026q\027)\312%\277\024\337\362\tc\255";
    PyObject *data = __Pyx_DecompressString(cstring, 211, 1);
    if (unlikely(!data)) __PYX_ERR(0, 1, __pyx_L1_error)
    const char* const bytes = __Pyx_PyBytes_AsString(data);
    #if !CYTHON_ASSUME_SAFE_MACROS
    if (likely(bytes)); else { Py_DECREF(data); __PYX_ERR(0, 1, __pyx_L1_error) }
    #endif
    #else /* compression: none (245 bytes) */
const char* const bytes = "?j2.pyx__Pyx_PyDict_NextRef__annotate__asyncio.coroutinescline_in_traceback__func___is_coroutineitemsj2__main____module____name__pop__qualname____set_name__setdefault__test__valuesxy\200\001\330\004\013\2105\220\003\2201\220A\220R\220r\230\024\230Q\230c\240\021\240!\2401\240D\250\001\250\023\250B\250a\250q\260\002\260\"\260D\270\001\270\023\270A\270Q\270a\270t\3001\300A";
    PyObject *data = NULL;
...
static int __Pyx_CreateCodeObjects(__pyx_mstatetype *__pyx_mstate) {
  ...
  if (unlikely(!tuple_dedup_map)) return -1;
  {
    ...
    __pyx_mstate_global->__pyx_codeobj_tab[0] = __Pyx_PyCode_New(descr, varnames, __pyx_mstate->__pyx_kp_u_j2_pyx, __pyx_mstate->__pyx_n_u_j2, __pyx_mstate->__pyx_kp_b_iso88591_5_1ARr_Qc_1D_Baq_D_AQat1A, tuple_dedup_map); if (unlikely(!__pyx_mstate_global->__pyx_codeobj_tab[0])) goto bad;
  }
