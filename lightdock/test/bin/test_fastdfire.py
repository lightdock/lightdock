...
class TestRegressionFastDFIREShort(RegressionTest):
    ...
    def setup(self):
        ...
        self.golden_data_path = os.path.normpath(os.path.dirname(os.path.realpath(__file__))) + \
                                '/golden_data/regression_fastdfire_short/'
...
class TestRegressionFastDFIRELong(RegressionTest):
    ...
    def setup(self):
        ...
        self.ini_test_path()
        self.golden_data_path = os.path.normpath(os.path.dirname(os.path.realpath(__file__))) + \
                                '/golden_data/regression_fastdfire_long/'
...
class TestRegressionFastDFIRERestraints(RegressionTest):
    ...
    def test_lightdock_2uuy_20_steps_25_glowworms_1_cluster(self):
        ...
        assert filecmp.cmp(self.golden_data_path + 'swarm_0/gso_0.out', self.test_path + 'swarm_0/gso_0.out')
        assert filecmp.cmp(self.golden_data_path + 'swarm_0/gso_10.out', self.test_path + 'swarm_0/gso_10.out')
        assert filecmp.cmp(self.golden_data_path + 'swarm_0/gso_20.out', self.test_path + 'swarm_0/gso_20.out')
