...
class TestGenerateTrajectory(RegressionTest):
    ...
    def test_generate_trajectory(self):
        ...
        swarm_dir = 'swarm_0'
        os.mkdir(swarm_dir)
        shutil.copyfile(self.golden_data_path / swarm_dir / 'gso_0.out',
        ...
        command = f"lgd_generate_trajectory.py 4 10 {receptor} {ligand} {setup} > test.out"
        os.system(command)

        assert filecmp.cmp(self.golden_data_path / 'swarm_0' / 'trajectory_4_step_0.pdb',
                           self.test_path / 'swarm_0' / 'trajectory_4_step_0.pdb')
        assert filecmp.cmp(self.golden_data_path / 'swarm_0' / 'trajectory_4_step_10.pdb',
