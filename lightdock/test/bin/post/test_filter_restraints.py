...
class TestFilterRestraints(RegressionTest):
    ...
    def test_filter_restraints(self):
        ...
        shutil.copyfile(self.golden_data_path / 'restraints.list', self.test_path / 'restraints.list')
        ...
        assert filecmp.cmp(self.golden_data_path / 'filtered' / 'rank_filtered.list',
                           self.test_path / 'filtered' / 'rank_filtered.list')
        assert filecmp.cmp(self.golden_data_path / 'filtered' / 'swarm_1_34.pdb',
                           self.test_path / 'filtered' / 'swarm_1_34.pdb')
        assert filecmp.cmp(self.golden_data_path / 'filtered' / 'swarm_2_16.pdb',
